    ...
    with open(run_folder_path + '/flow_completion.csv.log') as file:
        ...
        for j in range(0, len(range_name)):
            ...
            if range_num_finished_flows[j] != 0:
                ...
                if j==0:
                    mean = statistics[range_name[j] + '_mean_fct_ns'] / 1000000
                    median = statistics[range_name[j] + '_median_fct_ns'] / 1000000
                    th99 = statistics[range_name[j] + '_99th_fct_ns'] / 1000000
                    th999 = statistics[range_name[j] + '_99.9th_fct_ns'] / 1000000
        ...
        with open(analysis_folder_path + '/flow_completion10k.statistics', 'w+') as outfile:
            for key, value in sorted(statistics.items()):
                outfile.write(str(key) + "=" + str(value) + "\n")
        return mean,median,th99,th999


def analyze_flow_completion100():
    with open(run_folder_path + '/flow_completion.csv.log') as file:
        reader = csv.reader(file)
        ...
        # Print raw results
        print('Writing to result file flow_completion.statistics...')
        with open(analysis_folder_path + '/flow_completion100k.statistics', 'w+') as outfile:
            for key, value in sorted(statistics.items()):
                outfile.write(str(key) + "=" + str(value) + "\n")
        return mean,median,th99,th999
...
flows = {}
mean,median,th99,th999=analyze_flow_completion()
mean100,median100,th99100,th999100=analyze_flow_completion100()
