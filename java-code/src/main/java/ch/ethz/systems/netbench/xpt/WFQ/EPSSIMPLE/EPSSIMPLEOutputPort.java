...
import ch.ethz.systems.netbench.xpt.WFQ.EPSSIMPLE.EPSSIMPLEQueue;
import ch.ethz.systems.netbench.xpt.tcpbase.FullExtTcpPacket;




public class EPSSIMPLEOutputPort extends OutputPort {


    public EPSSIMPLEOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, long numQueues, long bytesPerRound) {
        super(ownNetworkDevice, targetNetworkDevice, link, new EPSSIMPLEQueue(numQueues, bytesPerRound, ownNetworkDevice.getIdentifier(), targetNetworkDevice.getIdentifier(), link.getBandwidthBitPerNs()));
    }
