...
import ch.ethz.systems.netbench.xpt.WFQ.PCQWB.PCQWBQueue;
import ch.ethz.systems.netbench.xpt.tcpbase.FullExtTcpPacket;




public class PCQWBOutputPort extends OutputPort {


    public PCQWBOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, long numQueues, long bytesPerRound) {
        super(ownNetworkDevice, targetNetworkDevice, link, new PCQWBQueue(numQueues, bytesPerRound, ownNetworkDevice.getIdentifier(), targetNetworkDevice.getIdentifier()));
    }
