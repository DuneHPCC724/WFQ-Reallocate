...
import ch.ethz.systems.netbench.xpt.AdaptiveWFQDCTCP.AdpWFQDCTCPTransportLayerGenerator;
...
import ch.ethz.systems.netbench.xpt.WFQ.EPSSIMPLE.EPSSIMPLEOutputPortGenerator;//WFQ+import EPSSIMPLEOutputPortGenerator
...
class InfrastructureSelector {
    ...
    static OutputPortGenerator selectOutputPortGenerator() {
        ...
        switch (Simulator.getConfiguration().getPropertyOrFail("output_port")) {
            ...
            case "pcq"://WFQ+pcq
                return new PCQOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_bytes_per_round")
                );
            case "epswfq"://WFQ+epswfq
            ...
            case "epssimple"://WFQ+epssimple
                return new EPSSIMPLEOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_bytes_per_round")
                );
            case "oepssimple"://WFQ+epssimple
                return new OEPSSIMPLEOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_bytes_per_round")
                );
            case "pcqburst"://WFQ+pcqburst
                return new PCQBURSTOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_bytes_per_round")
                );
            case "pifoour":
                return new PIFOOUROutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_bytes_per_round")
                );
            case "aifo":
    ...
    static TransportLayerGenerator selectTransportLayerGenerator() {
        ...
        switch (Simulator.getConfiguration().getPropertyOrFail("transport_layer")) {
            ...
            case "AdpWFQDCTCP":
                return new AdpWFQDCTCPTransportLayerGenerator();
            default:
                throw new PropertyValueInvalidException(
                        Simulator.getConfiguration(),
                        "transport_layer"
