...
//        this.roundTripTimeout = Simulator.getConfiguration().getLongPropertyWithDefault("TCP_ROUND_TRIP_TIMEOUT_NS", 300000L);
        this.roundTripTimeout = Simulator.getConfiguration().getLongPropertyWithDefault("TCP_ROUND_TRIP_TIMEOUT_NS", 600000L);
        ...
        switch (currentState) {
            ...
            case LISTEN: {
                ...
                if (packet.isSYN() && !packet.isACK()) {
                    ...
                    if(!Simulator.getActiveFlowPath().containsKey(packet.getFlowId())){
                        Simulator.AddFlow(packet.getFlowId(),packet.getPathIDs());
                    }
